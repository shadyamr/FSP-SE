...
<div class="container">
    ...
    <a href="{{ route('borrower.showAdd') }}" class="btn btn-success mt-3 mb-3 float-end">Add New Borrower</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <h4><span class="badge rounded-pill text-bg-success">Active</span></h4>
                    @else

                    <h4><span class="badge rounded-pill text-bg-warning">Returned</span></h4>
                    @endif
                </td>
                ...
                <td>
                    <a href="{{ route('borrower.showEdit', ['id' => $borrower->id]) }}" class="btn btn-secondary">Edit</a>
